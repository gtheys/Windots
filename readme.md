# Geert Theys Windows Dotfiles

Scott Mckendry has made some awesome windows based dotfiles and is trying to sync them with his linux ones. Also he deploys wsl2 with these linux dotfiles.

In first instance I'm just using as they are. But the goal is to make them my own.

First thoughts windows is more painful to do this. 
